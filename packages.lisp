(defpackage #:environment
  ...
  (:export
   ...
   #:environment-name-already-bound
   #:environment-immutable
   #:environment-name-not-bound
   #:environment-value-not-bound
   #:environment-frame-chain-empty
   #:do-lookup
   #:lookup
   #:name-bound-p
   #:bind
...
(defpackage #:allocation-pool
  ...
  (:export
   ...
   #:make-pool-backed-frame-chain
   #:pool-evaluate
   #:with-pool-subset
   #:pool-allocate-binding))
...
(defpackage #:dictionary
  ...
  (:export
   ...
   #:make-dictionary
   #:aliased-dictionary
   #:make-aliased-dictionary
   #:unknown-symbol
   #:dictionaries-not-form-subset-superset-relation
   #:dictionary-id-map
   #:symbol-id
   #:id-value
   #:set-id-value
